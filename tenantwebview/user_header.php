  ...
  <div class="header">
    ...
    <div class="navbar" id="navbar">
      <div class="navbarContent">
        ...
        <a href="USERHOMEPAGE.php#aboutRYC">About</a>
        <a href="USERHOMEPAGE.php#availUnitsContainer">Available Units</a>
        <div class="user-actions">
          <a href="USERACCOUNTPAGE.php" class="btn-login">Account</a>
